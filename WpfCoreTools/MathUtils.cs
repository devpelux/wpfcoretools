...
namespace WpfCoreTools
{
    ...
    public static class MathUtils
    {
        ...
        /// </remarks>
        public const double DOUBLE_EPSILON = 2.2204460492503131e-016;
        ...
        /// </returns>
        public static bool IsOne(double value) => Math.Abs(value - 1.0) < 10.0 * DOUBLE_EPSILON;
        ...
        /// </returns>
        public static bool IsZero(double value) => Math.Abs(value) < 10.0 * DOUBLE_EPSILON;
